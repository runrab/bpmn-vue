declare module 'bpmn-js-token-simulation' {
  ...
  import ExclusiveGatewaySettings
    from 'bpmn-js-token-simulation/lib/features/exclusive-gateway-settings/ExclusiveGatewaySettings'
  import PauseSimulation from 'bpmn-js-token-simulation/lib/features/pause-simulation/PauseSimulation'
  import PreserveElementColors
    from 'bpmn-js-token-simulation/lib/features/preserve-element-colors/PreserveElementColors'
  import ProcessInstanceIds from 'bpmn-js-token-simulation/lib/features/process-instance-ids/ProcessInstanceIds'
  import ProcessInstanceSettings
    from 'bpmn-js-token-simulation/lib/features/process-instance-settings/ProcessInstanceSettings'
  ...
  import TokenSimulationBehavior
    from 'bpmn-js-token-simulation/lib/features/token-simulation-behavior/TokenSimulationBehavior'
